    ...
    <div class="mainer">
        <div class="admin-navbar">
            <span class="float-right">
            	<a class="button button-little bg-main" href="/Blog/" target="_blank">前台首页</a>
                <a class="button button-little bg-yellow" href="/Blog/index.php/Admin/Login">注销登录</a>
            </span>
            <ul class="nav nav-inline admin-nav">
                <li class="active"><a href="/Blog/index.php/Admin/" class="icon-home"> 开始</a>
                	<ul>
    	...
    	<div class="xm3">
        	<div class="panel border-back">
            	<div class="panel-body text-center">
                	<img src="__PUBLIC__/images/face.jpg" width="120" class="radius-circle" /><br />
                    admin
                </div>
